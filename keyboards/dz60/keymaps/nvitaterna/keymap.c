...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    ______, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, KC_PSLS, KC_PAST, KC_PMNS, XXXXXX, XXXXXX, ______, ______, \
    ______, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, KC_7, KC_8, KC_9, KC_PPLS, XXXXXX, XXXXXX, XXXXXX, \
    ______, ______, ______, ______, XXXXXX, XXXXXX, XXXXXX, KC_P4, KC_P5, KC_6, KC_PPLS, XXXXXX, ______, \
    ...
    ______, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, ______, KC_PGUP, KC_INS, \
    ______, ______, ______, ______, ______, ______, ______, ______, KC_HOME, KC_PGDN, KC_END \
  ),
	[LIGHTING_LAYER] = LAYOUT_60_b_ansi( \
    RGB_TOG, RGB_M_P, RGB_M_R, RGB_M_B, L_BL, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, \
    XXXXXX, RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, \
    XXXXXX, RGB_HUD, RGB_SAD, RGB_VAD, RGB_SPD, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, XXXXXX, \
...
uint32_t layer_state_set_user(uint32_t state) {
  if (layer_mode && rgblight_config.enable) {
